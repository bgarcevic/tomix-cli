...
/// <summary>
/// Reads and writes local MDL preferences as a flat JSON map at <see cref="MdlPaths.ConfigFile"/>.
...
/// </summary>
public sealed class MdlConfigStore
{
    private static readonly JsonSerializerOptions SerializerOptions = new() { WriteIndented = true };

    private readonly string _path;

    public MdlConfigStore()
        : this(MdlPaths.ConfigFile)
    {
    }

    public MdlConfigStore(string path) => _path = path;
