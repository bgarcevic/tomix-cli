...
public sealed class InteractiveHandler
{
    ...
    public MdlResult<InteractiveStartResult> Start(InteractiveStartRequest request)
    {
        ...
        return MdlResult<InteractiveStartResult>.Ok(new InteractiveStartResult(
